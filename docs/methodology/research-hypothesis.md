...
## Characterization of the Application Context
...
**Application Context**: The application context of this work is the automation of modular production systems in specialty and pharmaceutical industry for the systematic implementation of flexibility and adaptability.

## Current Approaches to Implementing Flexibility and Adaptability
...
- **Automation Services**: Fully implemented state machines representing encapsulated automation functions
- **Process Value Interconnections**: Enable cross-control connections of basic automation
- **Distributed Architecture**: Process values are transmitted by the POL from one process value output of a PEA to a process value input of another PEA

Key features:
- Automation services and their process values encapsulate automation functions
...
![IT Orchestration vs Choreography](./Vergleich_Orchestrierung_Choreografie_IT.drawio.png)
